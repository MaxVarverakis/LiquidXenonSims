...
Traditional targets are composed of high-Z metals and become brittle over time due to constant bombardment by high-power electron beams.
...
Using the GEANT4 simulation code, we examine the performance of the liquid Xenon target and show that the positron yield and divergence are comparable to solid targets when normalizing by radiation length.
...
% discuss practicalities and cost stuff
